      ...
      <div className="login-content">
        ...
        <div className="login-card">
          ...
          <div className="login-buttons">
            {/* Google Login */}
            <a href="/dashboard" className="login-btn login-btn-google">
              ...
              <span className="login-btn-text">Google로 로그인</span>
            </a>

            {/* Kakao Login */}
            <a href="/dashboard" className="login-btn login-btn-kakao">
              <svg className="login-icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Naver Login */}
            <a href="/dashboard" className="login-btn login-btn-naver">
